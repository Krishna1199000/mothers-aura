        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          ...
          <div className={`transform transition-all duration-1000 delay-200 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            <div className={`relative group transition-all duration-500 ${hoursExpanded ? 'scale-105' : 'scale-100'}`}>
              {/* Main Image */}
              <div className="relative overflow-hidden rounded-2xl shadow-lg border border-gray-200 h-full">
                <Image
                ...
                <div className="absolute top-6 right-6 bg-white rounded-lg px-5 py-3 shadow-lg border border-gray-200">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-black">Expert Consultation</h4>
                          <p className="text-gray-600 text-sm">Personalized diamond selection with certified gemologists</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-black">Certified Quality</h4>
                          <p className="text-gray-600 text-sm">Every diamond comes with GIA or IGI certification</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-black">Lifetime Warranty</h4>
                          <p className="text-gray-600 text-sm">Comprehensive protection for your precious investment</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className={`space-y-4 transform transition-all duration-1000 delay-400 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-500 overflow-hidden group cursor-pointer transform hover:-translate-y-1 ">
              <div className="p-6">
                ...
                <button className="w-full bg-black text-white font-semibold py-4 rounded-xl transition-all duration-300 hover:bg-gray-800">
                  Schedule Now
                </button>
              </div>
            </div>
                ...
                <div className="px-6 pb-6 space-y-2 border-t border-gray-100 pt-4">
                  {storeHours.map((schedule, index) => (
                    ...
                    >
                      ...
                      <span className={`font-medium ${schedule.open ? 'text-gray-700' : 'text-red-600'}`}>
                        {schedule.hours}
                      </span>
                    </div>
                  ))}
